...
def launch_setup(context, *args, **kwargs):
    ...
    moveit_rviz_config_file = PathJoinSubstitution([
        FindPackageShare("ur10e_mod_moveit_config"), 
        "config", 
        "moveit.rviz"
    ])
    ...
    rviz_node = Node(
        ...
        name="rviz2",
        output="screen",
        arguments=["-d", IfElseSubstitution(
            launch_rviz,
            if_value=moveit_rviz_config_file,
            else_value=rviz_config_file
        )],
        parameters=[
    ...
    # Initial joint controller spawners
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution(
                [FindPackageShare("ur10e_mod"), "config", "ur_controllers_with_z_lift.yaml"]
            ),
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",
            default_value=PathJoinSubstitution(
                [FindPackageShare("ur10e_mod"), "urdf", "ur10e_mod_gz.urdf.xacro"]
            ),
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            description="Fallback RViz config file.",
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
